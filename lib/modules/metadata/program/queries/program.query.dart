...
class ProgramQuery extends BaseQuery<Program> {
  ...
  ProgramQuery withProgramStages() {
    final programStage = Repository<ProgramStage>(database: database as Database);
  ...
  ProgramQuery withAttributes() {
    final programAttribute = Repository<ProgramTrackedEntityAttribute>(database: database as Database);
  ...
  ProgramQuery withProgramRuleVariables() {
    final programRuleVariable = Repository<ProgramRuleVariable>(database: database as Database);
  ...
  ProgramQuery withSections() {
    final programSection = Repository<ProgramSection>(database: database as Database);

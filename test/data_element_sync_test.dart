...
void main() async {
  ...
  dioAdapter.onGet(
    'https://play.dhis2.org/2.35.11/api/dataElements.json?fields=id,dirty,lastUpdated,created,name,displayName,shortName,code,formName,valueType,aggregationType,description,optionSet&paging=false',
